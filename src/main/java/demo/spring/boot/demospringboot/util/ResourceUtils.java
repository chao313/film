...
/**
 * copy from package org.springframework.util
 */
...
public abstract class ResourceUtils {
     ...
     * resource in a jar file or to a jar file itself). <p>In the case of a jar file nested within a
     * war file, this will return a URL to the war file since that is the one resolvable in the file
     * system.
     *
     * @param jarUrl the original URL
     * @return the URL for the actual jar file
